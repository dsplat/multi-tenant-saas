...
return [
    ...
    'not_in_tenant' => '您不属于该团队',
    'tenant_admin_only' => '仅团队管理员可以访问管理后台',
    ...
    'alipay' => '支付宝',
    'cancelled' => '已取消',
    'oauth_not_configured' => '团队 :tenant 未配置 :provider OAuth',
    ...
    'cross_tenant_forbidden' => '禁止跨团队访问',
    ...
    'tenant_inactive' => '团队未激活',
    'trial_start_failed' => '试用启动失败',
    'migration_same_tenant' => '不能迁移到同一团队',
    ...
    'cost_ai_allocated' => 'AI 用量成本已归入团队',
    'cost_report_generated' => '月度成本报表已生成',
    'cost_forecast_completed' => '成本趋势预测已完成',
    'cost_profit_loss_calculated' => '团队盈亏分析已完成',
    ...
    'error_impact_analyzed' => '错误影响面分析完成：影响 :tenants 个团队、:users 个用户',
