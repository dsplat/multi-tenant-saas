...
// 管理员后台 - RBAC 管理
Route::middleware(['auth:sanctum', 'rbac.permission:rbac.manage'])->prefix('auth')->group(function () {
...
// 管理员后台 - SSO 管理
Route::middleware(['auth:sanctum', 'rbac.permission:setting.update'])->prefix('auth/sso')->group(function () {
