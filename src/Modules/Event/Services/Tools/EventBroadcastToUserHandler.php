...
class EventBroadcastToUserHandler implements ToolHandlerContract
{
    public function __construct(private readonly BroadcastingService $service) {}

    public function __invoke(array $arguments, int $tenantId): mixed
    {
        return $this->service->broadcastToUser((int) $arguments['user_id'], $arguments['event'], $arguments['data']);
    }
}
