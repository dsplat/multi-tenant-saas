...
class KnowledgeUpdateConnectionHandler implements ToolHandlerContract
{
    public function __construct(private readonly ExternalKbService $service) {}

    public function __invoke(array $arguments, int $tenantId): mixed
    {
        return $this->service->updateConnection((int) $arguments['connection_id'], $arguments['name'] ?? null, $arguments['config'] ?? []);
    }
}
