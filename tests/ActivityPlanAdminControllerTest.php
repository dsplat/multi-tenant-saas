...
/**
 * 活动排期管理 API：403（member）/ 建计划校验 422 / compile / approve 后执行 / complete
 */
class ActivityPlanAdminControllerTest extends TestCase
{
    protected array $uses = [ActivityPlanModule::class, AgentModule::class, AiModule::class, RbacModule::class];
