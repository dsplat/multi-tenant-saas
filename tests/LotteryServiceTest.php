...
class LotteryServiceTest extends TestCase
{
    ...
    public function test_update_activity(): void
    {
        ...
        $updated = $this->lotteryService->updateActivity($activity->activity_id, [
            'title' => '新标题',
        ]);
    ...
    public function test_get_activity_with_prizes(): void
    {
        ...
        $result = $this->lotteryService->getActivity($activity->activity_id);
    ...
    public function test_get_activities(): void
    {
        ...
        $activities = $this->lotteryService->getActivities(1001);
    ...
    public function test_get_activities_filter_by_status(): void
    {
        ...
        $active = $this->lotteryService->getActivities(1001, ['status' => 'active']);
    ...
    public function test_update_activity_status(): void
    {
        ...
        $updated = $this->lotteryService->updateActivityStatus($activity->activity_id, 'active');
    ...
    public function test_add_prize(): void
    {
        ...
        $prize = $this->lotteryService->addPrize($activity->activity_id, [
            'name' => 'iPhone',
            'type' => 'physical',
            'value' => 999,
            'total_count' => 10,
    ...
    public function test_update_prize(): void
    {
        ...
        $updated = $this->lotteryService->updatePrize($prize->prize_id, [
            'name' => '新奖品',
        ]);
    ...
    public function test_delete_prize(): void
    {
        ...
        $result = $this->lotteryService->deletePrize($prize->prize_id);
    ...
    public function test_get_prizes(): void
    {
        ...
        $prizes = $this->lotteryService->getPrizes($activity->activity_id);
    ...
    public function test_draw_win(): void
    {
        ...
        $result = $this->lotteryService->draw($activity->activity_id, 2001, '127.0.0.1', 'TestAgent');
    ...
    public function test_draw_inactive_activity_throws(): void
    {
        ...
        $this->lotteryService->draw($activity->activity_id, 2001, '127.0.0.1', 'TestAgent');
    }
    ...
    public function test_draw_blacklisted_user(): void
    {
        ...
        $this->lotteryService->addToBlacklist($activity->tenant_id, $activity->activity_id, 'user_id', '2001', '作弊');
    ...
    public function test_draw_blacklisted_ip(): void
    {
        ...
        $this->lotteryService->addToBlacklist($activity->tenant_id, $activity->activity_id, 'ip', '192.168.1.1', '恶意IP');

        $result = $this->lotteryService->draw($activity->activity_id, null, '192.168.1.1', 'TestAgent');
    ...
    public function test_add_to_blacklist(): void
    {
        ...
        $blacklist = $this->lotteryService->addToBlacklist($activity->tenant_id, $activity->activity_id, 'user_id', '2001', '作弊');
    ...
    public function test_remove_from_blacklist(): void
    {
        ...
        $this->lotteryService->addToBlacklist($activity->tenant_id, $activity->activity_id, 'user_id', '2001', '作弊');
        $result = $this->lotteryService->removeFromBlacklist($activity->activity_id, 'user_id', '2001');

        $this->assertTrue($result);
        $this->assertFalse($this->lotteryService->isBlacklisted($activity->activity_id, 'user_id', '2001'));
    }
    ...
    public function test_is_blacklisted(): void
    {
        ...
        $this->assertTrue($this->lotteryService->isBlacklisted($activity->activity_id, 'user_id', '2001'));
        $this->assertFalse($this->lotteryService->isBlacklisted($activity->activity_id, 'user_id', '2002'));
    }
    ...
    public function test_get_blacklist(): void
    {
        ...
        $this->lotteryService->addToBlacklist($activity->tenant_id, $activity->activity_id, 'user_id', '2001', '原因1');
        $this->lotteryService->addToBlacklist($activity->tenant_id, $activity->activity_id, 'ip', '192.168.1.1', '原因2');

        $blacklist = $this->lotteryService->getBlacklist($activity->activity_id);
    ...
    public function test_get_draw_stats(): void
    {
        ...
        $this->lotteryService->draw($activity->activity_id, 2001, '127.0.0.1', 'TestAgent');
        $this->lotteryService->draw($activity->activity_id, 2002, '127.0.0.2', 'TestAgent');

        $stats = $this->lotteryService->getDrawStats($activity->activity_id);
    ...
    public function test_get_user_draw_logs(): void
    {
        ...
        $logs = $this->lotteryService->getUserDrawLogs($activity->activity_id, 2001);
    ...
    public function test_get_win_logs(): void
    {
        ...
        $winLogs = $this->lotteryService->getWinLogs($activity->activity_id);
