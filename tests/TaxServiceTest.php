...
class TaxServiceTest extends TestCase
{
    ...
    public function test_calculate_with_matching_region(): void
    {
        ...
        $result = $this->taxService->calculateTax('CN', 100);
    ...
    {
        $result = $this->taxService->calculateTax('US', 200);
    ...
    {
        $result = $this->taxService->calculateTax('EU', 100);
    ...
    public function test_calculate_unsupported_region_throws(): void
    {
        ...
        $this->taxService->calculateTax('XX', 100);
    }
    ...
    public function test_get_applicable_rate(): void
    {
        ...
        $rule = $this->taxService->getApplicableRate('US');
    ...
    {
        $rule = $this->taxService->getApplicableRate('CN');
    ...
    public function test_calculate_precision(): void
    {
        ...
        $result = $this->taxService->calculateTax('CN', 33.33);
    ...
    public function test_calculate_uk_region(): void
    {
        ...
        $result = $this->taxService->calculateTax('UK', 100);
    ...
    public function test_calculate_eu_region(): void
    {
        ...
        $result = $this->taxService->calculateTax('EU', 200);
    ...
    {
        $this->assertTrue($this->taxService->validateTaxNumber('CN', '123456789012345'));
    }

    public function test_validate_cn_tax_number_18(): void
    {
        $this->assertTrue($this->taxService->validateTaxNumber('CN', '123456789012345678'));
    }

    public function test_validate_cn_tax_number_20(): void
    {
        $this->assertTrue($this->taxService->validateTaxNumber('CN', '12345678901234567890'));
    }

    public function test_validate_cn_tax_number_invalid_length(): void
    {
        $this->assertFalse($this->taxService->validateTaxNumber('CN', '12345'));
    }

    public function test_validate_eu_vat_number(): void
    {
        $this->assertTrue($this->taxService->validateTaxNumber('EU', 'DE123456789'));
        $this->assertTrue($this->taxService->validateTaxNumber('EU', 'FR12345678901'));
    }

    public function test_validate_eu_vat_number_invalid(): void
    {
        $this->assertFalse($this->taxService->validateTaxNumber('EU', '123456789'));
    }

    public function test_validate_uk_vat_number(): void
    {
        $this->assertTrue($this->taxService->validateTaxNumber('UK', 'GB123456789'));
        $this->assertTrue($this->taxService->validateTaxNumber('UK', 'GB123456789012'));
    }

    public function test_validate_uk_vat_number_invalid(): void
    {
        $this->assertFalse($this->taxService->validateTaxNumber('UK', 'GB12345'));
    }

    public function test_is_exempt_for_export(): void
    {
        $this->assertTrue($this->taxService->isExempt('CN', 'export'));
        $this->assertTrue($this->taxService->isExempt('CN', 'exempt'));
    }

    public function test_is_not_exempt_for_standard(): void
    {
        $this->assertFalse($this->taxService->isExempt('CN', 'standard'));
    }

    public function test_is_exempt_returns_false_when_no_product_type(): void
    {
        $this->assertFalse($this->taxService->isExempt('CN'));
    }

    public function test_calculate_exempt_product(): void
    {
        $result = $this->taxService->calculateTax('CN', 100, 'export');
